...
async def cmd_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        "• <code>GBPUSD M5</code>\n"
        "• <code>AUDUSD H1</code>\n"
        "• <code>USDJPY M15</code>\n"
        "• <code>EURJPY M30</code>\n"
        "• <code>NAS100 M5</code>\n"
        "• <code>US30 H1</code>\n\n"
        "<b>Pair forex (utama):</b> semua mayor & cross (EURUSD, GBPUSD, AUDUSD, USDJPY, EURJPY, GBPJPY, dll)\n"
...
async def cmd_help(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    help_text += "<b>Pair Forex (utama):</b>\n"
    help_text += "• Majors: EURUSD, GBPUSD, AUDUSD, NZDUSD, USDJPY, USDCHF, USDCAD\n"
    help_text += "• Cross: EURJPY, GBPJPY, AUDJPY, NZDJPY, CADJPY, CHFJPY\n"
    help_text += "• Lainnya: EURGBP, EURAUD, GBPAUD, AUDCAD, dll\n\n"
    help_text += "<b>Indices:</b> NAS100, US30, SPX500, DAX, FTSE, NIKKEI\n"
    help_text += "<b>Lainnya:</b> XAU (gold), XAG (silver), OIL (CL)\n\n"
    help_text += "<b>Timeframe:</b> M1, M5, M15, M30, M45, H1, H2, H4, H8, D1\n\n"
    help_text += "<b>Cara pakai:</b>\n"
    help_text += "Ketik: <code>SIMBOL TF</code>\n"
    help_text += "Contoh: <code>GBPUSD M5</code> atau <code>USDJPY M15</code>\n\n"
